<%-- 
    Document   : errorPerfil
    Created on : 5/03/2019, 03:58:27 PM
    Author     : deivi
--%>
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header error-page header-filter" style="background-image: url('./complementos/assets/img/clint-mckoy.jpg')">
